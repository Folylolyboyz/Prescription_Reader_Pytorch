...
print(os.path.join("Inference", "Page"))

parser = argparse.ArgumentParser()
parser.add_argument('--data', type=Path, default=os.path.join("Inference", "Page"))
...
for fn_img in get_img_files(parsed.data):
    ...
    wordDir = os.path.join("Inference", "Words")
    
    if os.path.exists(wordDir) == False:
        os.mkdir(wordDir)
